const content = {
  es: `
    <section><h2>🟢 Agregado [+]</h2><ul><li>End</li><li>Cactus</li><li>AntiPearl</li><li>Cocaine</li><li>SnakeBite</li><li>/falltrap</li><li>/skybase</li><li>Unban All</li></ul></section>
    <section><h2>🔴 Removido [-]</h2><ul><li>TimeStone</li><li>Werid Luck</li><li>Size Ability</li><li>Webber</li><li>RiskyMode</li></ul></section>
    <section><h2>🟡 Nerf [-!]</h2><ul><li><strong>Recall</strong>: Ahora solo podrás usarla si el último enemigo que te golpeó en los últimos 10 segundos está a una distancia de 8 bloques o menos.</li><li>Las puertas ahora no se podran craftear, ni poner de ninguna manera</li></ul></section>
    <section><h2>🔵 Buff [+!]</h2><ul><li><strong>HogRaider</strong>: Ahora le da efectos a los compañeros de faction que estén en un radio de 10 bloques.<br>Antes, cuando moría daba un efecto aleatorio por 4 segundos.<br>Ahora: da efectos por 6 segundos, pero se redujo su tiempo de vida.</li><li>Sullcraft: Ahora rompe cualquier tipo de valla</li></ul></section>
  ...
  `,
  en: `
    <section><h2>🟢 Added [+]</h2><ul><li>End</li><li>Cactus</li><li>AntiPearl</li><li>Cocaine</li><li>SnakeBite</li><li>/falltrap</li><li>/skybase</li><li>Unban All</li></ul></section>
    <section><h2>🔴 Removed [-]</h2><ul><li>TimeStone</li><li>Werid Luck</li><li>Size Ability</li><li>Webber</li><li>RiskyMode</li></ul></section>
    <section><h2>🟡 Nerf [-!]</h2><ul><li><strong>Recall</strong>: You can now only use it if the last enemy that hit you in the last 10 seconds is within 8 blocks.</li><li>Doors can no longer be crafted or placed in any way</li></ul></section>
    <section><h2>🔵 Buff [+!]</h2><ul><li><strong>HogRaider</strong>: Now gives effects to faction teammates within a 10-block radius.<br>Previously gave a random effect on death for 4 seconds.<br>Now: effects last 6 seconds, but its lifetime has been reduced.</li><li>Sullcraft: Now breaks any type of fence</li></ul></section>
